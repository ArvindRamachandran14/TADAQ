...
class producer() :
	...
	def produce(self) :
		...
		while not self.bDone :
			...
			if command == '%EXIT' :
				...
				tash.recIdx = recIdx
				print('P: {0:4d} {1:10.3f} {2:10.3f} {3:10.3f} {4:10.3f} {5:10.3f} {6:10.3f} {7:10.3f} {8:10.3f} {9:10.3f} {10:10.3f} {11:10.3f} {12:10.3f} {13:10.3f} {14:10.3f} {15:10.3f} {16:10.3f} {17:10.3f} {18:10.3f} {19:10.3f} {20:10.3f} {21:10.3f} {22:10.3f} {23:10.3f} {24:10.3f} {25:10.3f} {26:10.3f} {27:10.3f} {28:10.3f} {29:10.3f} {30:10.3f} {31:10.3f}, {32:d}, {33:d}'.format( \
	...
	def getDataFromTA(self) :
		...
		keys = 	['SC_T1','SC_T2','CC_T1','DPG_T1','SC_T_Set','CC_T_Set','DPG_T_Set','SC_P','CC_P','DPG_P','SC_I','CC_I','DPG_I','SC_D','CC_D','DPG_D','SC_State','CC_State','DPG_State','SC_Output','CC_Output','DPG_Output','Cell_pressure','Cell_temp','IVOLT','pH2O','pCO2','Dew_point_temp','Sample_weight','V_state','Run','Status']
